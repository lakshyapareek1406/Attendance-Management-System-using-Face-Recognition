...
from tkinter import *
import cv2
print(cv2.__version__)  # Add this line temporarily to verify installation
import csv
import os
import numpy as np
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='Lakshya@2004', db='manually_fill_attendance')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
                ...
                try:
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        cv2.imwrite("TrainingImage/ " + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                    gray[y:y+h, x:x+w])
                        print(f"Images Saved: {sampleNum}")
                    ...
                    try:
                        ...
                        # If GUI operations fail, just continue capturing
                        pass
            ...
            print(f"Error: {str(e)}")
            Notification.configure(
                text="Error during image capture", 
                bg="red", 
                width=50, 
                font=('times', 18, 'bold'))
            Notification.place(x=250, y=400)
